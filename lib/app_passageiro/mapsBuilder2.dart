...
class mapsBuilder2 extends StatefulWidget {
  const mapsBuilder2({Key? key}) : super(key: key);

  @override
  _mapsBuilder2State createState() => _mapsBuilder2State();
}

class _mapsBuilder2State extends State<mapsBuilder2> {
                  ...
                  onEmpty: (context) {
                    GoogleMap(
                      ...
                      initialCameraPosition: CameraPosition(
                          target: LatLng(-22.423759, -45.452240), zoom: 14),
                      markers: markers,
                    );
                  },
